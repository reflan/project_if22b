      ...
      child: Column(
        children: [
          Container(
            ...
            child: Image(
              image: NetworkImage(
                  'https://raw.githubusercontent.com/reflan/project_if22b/main/asset/images/Web-header-UTI-23.jpg'),
            ),
          ),
          Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    IconButton('Menu 5', Icons.access_alarm, 0),
                    IconButton('Menu 6', Icons.baby_changing_station, 0),
                    IconButton('Menu 7', Icons.cabin, 0),
                    IconButton('Menu 8', Icons.radar, 0),
                  ],
                ),
              ],
            ),
